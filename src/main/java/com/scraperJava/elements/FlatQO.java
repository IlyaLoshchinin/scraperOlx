...
//    }
  ...
  void init(ActionTypePropertyOlx property, ActionTypePropertyOlx propertySubcategory,
      String queryInSearchField, long priceFrom, long priceTo, int roomFrom, int roomTo,
      int livingAreaFrom, int livingAreaTo, int levelFrom, int levelTo, InterestType interestType,
      DistrictKiev district, boolean withPhoto, CurrencyType currency) {
